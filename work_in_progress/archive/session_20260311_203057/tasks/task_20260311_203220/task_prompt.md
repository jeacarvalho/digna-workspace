# 📋 TAREFA: Corrigir bugs diversos após implementações até aqui
...
Criar um teste E2E "completo" que passe pelo menos pela "entrada" de todas as funcionalidade e evitem que uma sessão ou tarefa seja concluída com erros como os a seguir:
- http://localhost:8090/supply/stock?entity_id=cafe_digna --> Erro ao buscar estoque: database connection is closed: sql: database is closed
- http://localhost:8090/supply/suppliers?entity_id=cafe_digna --> idem

Você, agente, deve completar as próximas sessões com as informações necessárias e que as entendeu a partir desse objetivo 
