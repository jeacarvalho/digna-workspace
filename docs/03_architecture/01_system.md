...
status: implemented version: 1.6 last_updated: 2026-03-13
#### Arquitetura do Sistema - Digna
**Projeto:**  Sistema de Gestão Contábil e Pedagógica para Economia Solidária  **Arquitetura:**  Local-First Server-Side com Micro-databases Isolados + Domain-Driven Design
...
*   **Adequação Estatal [NOVO]:** Integração de APIs de Assinatura Eletrônica Gov.br (Lei nº 14.063/2020) para membros da mesa e algoritmo de anonimização de votos para garantir o escrutínio secreto em assembleias virtuais (IN DREI nº 79/2020).
##### tax_compliance (Conformidade Tributária) [NOVO]
*   **Responsabilidade:**  Motor silencioso de obrigações acessórias de retenções e blindagem do Ato Cooperativo.
*   **Características:** Geração e transmissão de XMLs via Web Service para a EFD-Reinf (alimentando a DCTFWeb). Integra inteligência para compor o Bloco M da ECF (e-Lalur/e-Lacs), isolando transações de mercado e expurgando as receitas de atos cooperativos da base de cálculo.
##### sanitary_compliance (Inclusão Sanitária MAPA/SIF) [NOVO]
*   **Responsabilidade:**  Facilitar a legalização de pequenas agroindústrias (queijarias, mel, carnes) vencendo a barreira do SIF.
*   **Características:** Parametrização arquitetônica de plantas fabris e fluxogramas para a geração automatizada do Memorial Técnico Sanitário de Estabelecimento (MTSE), exportável para o peticionamento no SEI conforme Portaria MAPA nº 393/2021.
...
*   **Integração CADSOL Atualizada [NOVO]:** Consumo previsto de APIs governamentais diretas do SINAES/CADSOL para o registro automatizado de entidades *FORMALIZED* (Decreto nº 12.784/2025).
...
##### 5.4 Novos Módulos de Adequação Estatal (Backlog) [NOVO]
A serem priorizados nas próximas Sprints visando a conformidade regulatória plena sem onerar o usuário final:
*   **`tax_compliance`**: Motor de obrigações acessórias EFD-Reinf/DCTFWeb e e-Lalur/e-Lacs (ECF).
*   **`sanitary_compliance`**: Motor gerador de MTSE para agroindústrias via MAPA/SIF.
